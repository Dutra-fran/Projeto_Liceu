...
<html lang="pt-br">
    ...
    <body>
        ...
        <?php
            ...
            $busca1 = "SELECT * FROM Fisica WHERE ID_Sala = '".$dados['ID_Sala']."'";
            $resultado1 = mysqli_query($conn, $busca1);
            $row1 = mysqli_num_rows($resultado1);
            
            if($row1 > 0){
              $_SESSION['disciplina'] = "Fisica";
              ...
              if($row == 0){
                ...
                $_SESSION['mensagem_prova'] = "Você já entrou na prova de Física, portanto, não tem mais acesso de entrada para a prova.";
              ...
              echo "<br><br><h2>Prova de Física não está disponível no momento!</h2>";
            }
